...
app.layout = html.Div([dcc.Markdown("WELCOME TO THE \"LEARNING HOW TO COUNT\"!",
                       ...
                       html.Div(dcc.Markdown(
                           "This project aims to help you with problems, which involve counting number of ways some objects can be chosen, or arranged, or distributed, etc. We prepared some questions, which will lead you to right formulas with explanation and typical examples. Without further ado...",
