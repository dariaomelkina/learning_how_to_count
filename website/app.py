...
app.layout = html.Div([dcc.Markdown("WELCOME TO THE 'LEARNING HOW TO COUNT'!",
                       ...
                       dcc.Markdown("INITIAL QUESTION?",
                                    style={'color': question, 'margin-left': 580, 'font-size': '30px', 'margin-top': 20}),
                       html.Div([dcc.Link(html.Button("first choice 1", style={'width': 400,'height':250, 'color': button_font, 'margin-left': 300, 'font-size': '30px',
                                                                               'display': 'inline-block', "background":button_bg1}), href='/1',
                                          refresh=True),
                                 dcc.Link(html.Button("second choice 1", style={'width': 400,'height':250,"background":button_bg2, 'color': button_font, 'margin-left': 10, 'font-size': '30px',
...
app1.layout = html.Div([dcc.Markdown("ANOTHER QUESTION? (1)",
                                     style={'color': 'gray', 'margin-left': 500, 'font-size': '30px',
                                            'margin-top': 50}),
...
app2.layout = html.Div([dcc.Markdown("ANOTHER QUESTION? (2)",
                                     style={'color': 'gray', 'margin-left': 500, 'font-size': '30px',
                                            'margin-top': 50}),html.Div([dcc.Link(html.Button("first choice 2", style={'width': 400,'height':250, 'color': button_font, 'margin-left': 300, 'font-size': '30px',
                                                                               'display': 'inline-block', "background":button_bg1}), href='/fin',
                                          refresh=True),
                                 dcc.Link(html.Button("second choice 2", style={'width': 400,'height':250,"background":button_bg2, 'color': button_font, 'margin-left': 10, 'font-size': '30px',
                                                                                'display': 'inline-block'}), href='/fin',
                                          refresh=True)]),
dcc.Markdown("CHOOSE WISELY, NEO...",
                                    style={'color': 'grey', 'margin-left': 620, 'font-size': '15px', 'margin-top': 20}),
